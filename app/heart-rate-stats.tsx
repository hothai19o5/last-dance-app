...
export default function HeartRateStatsScreen() {
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, { color: colors.text }]}>Heart Rate Statistics</Text>
                ...
                <>
                    ...
                    <View style={styles.summaryContainer}>
                        ...
                        <View style={[styles.summaryCard, { backgroundColor: colors.cardBackground }]}>
                            ...
                            <Text style={[styles.summaryValue, { color: colors.text }]}>{min.toFixed(0)}</Text>
                            <Text style={[styles.summaryUnit, { color: colors.textSecondary }]}>bpm</Text>
                        </View>
                        <View style={[styles.summaryCard, { backgroundColor: colors.cardBackground }]}>
                    ...
                    <View style={[styles.chartCard, { backgroundColor: colors.cardBackground }]}>
                        ...
                        <View style={styles.chartContainer}>
                            <LineChart
                                ...
                                hideRules
                                dataPointsColor={colors.heartRateColor}
                                dataPointsRadius={3}
                                height={250}
                                width={width - 72}
                                noOfSections={4}
                                ...
                                startFillColor={colors.heartRateColor + '40'}
                                endFillColor={colors.heartRateColor + '10'}
                                areaChart
                            />
                        </View>
                    </View>
