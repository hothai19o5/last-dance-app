...
export default function WaterStatsScreen() {
    ...
    const loadData = async () => {
        setLoading(true);
        try {
            const data = await statisticsService.getWaterStats(range);
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, { color: colors.text }]}>Water Intake Statistics</Text>
                ...
                <>
                    ...
                    <View style={styles.summaryContainer}>
                        <View style={[styles.summaryCard, { backgroundColor: colors.cardBackground }]}>
                            ...
                            <Text style={[styles.summaryUnit, { color: colors.textSecondary }]}>ml</Text>
                        </View>
                        <View style={[styles.summaryCard, { backgroundColor: colors.cardBackground }]}>
                    ...
                    <View style={[styles.chartCard, { backgroundColor: colors.cardBackground }]}>
                        ...
                        <View style={styles.chartContainer}>
                            <BarChart
                                ...
                                barBorderRadius={4}
                                frontColor={colors.waterIntakeColor}
                                yAxisThickness={0}
                                xAxisThickness={1}
