...
export default function SpO2StatsScreen() {
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, { color: colors.text }]}>SpO2 Statistics</Text>
                    ...
                    <View style={[styles.chartCard, { backgroundColor: colors.cardBackground }]}>
                        ...
                        <View style={styles.chartContainer}>
                            <LineChart
                                ...
                                hideRules
                                dataPointsColor={colors.spO2Color}
                                dataPointsRadius={3}
                                height={250}
                                width={width - 72}
                                noOfSections={4}
                                ...
                                startFillColor={colors.spO2Color + '40'}
                                endFillColor={colors.spO2Color + '10'}
                                areaChart
                            />
                        </View>
                    </View>
