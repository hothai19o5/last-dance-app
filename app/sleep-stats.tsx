...
export default function SleepStatsScreen() {
    ...
    const loadData = async () => {
        setLoading(true);
        try {
            const data = await statisticsService.getSleepStats(range);
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, { color: colors.text }]}>Sleep Statistics</Text>
                ...
                <>
                    ...
                    <View style={[styles.chartCard, { backgroundColor: colors.cardBackground }]}>
                        ...
                        <View style={styles.chartContainer}>
                            <BarChart
                                data={chartData.map(d => ({ ...d, value: d.value / 60 }))} // Convert to hours for display
                                barWidth={range === 'day' ? 12 : 30}
                                spacing={range === 'day' ? 8 : 12}
                                barBorderRadius={4}
                                frontColor={colors.sleepColor || colors.info}
                                yAxisThickness={0}
                                xAxisThickness={1}
